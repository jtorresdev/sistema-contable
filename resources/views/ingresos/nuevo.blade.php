...
<div class="page-content-wrapper">
	...
	<div class="page-content">
		<!-- BEGIN PAGE HEADER-->
		<!-- BEGIN PAGE TITLE-->
		<h1 class="page-title">Añadir nuevo ingreso</h1>
		<!-- END PAGE TITLE-->
		<!-- END PAGE HEADER-->
			...
			<div class="col-md-12">
				...
				<div class="portlet light bordered">
					...
					<div class="portlet-body form">
						<form role="form" method="POST" action="{{ url('ingresos/store') }}" enctype="multipart/form-data">
							{{ csrf_field() }}
									...
									<div class="row">
										...
										<div class="col-md-8" style="padding-top: 5px;">
											<label class="mt-checkbox mt-checkbox-outline" style="padding-right: 20px;">
												<input type="checkbox" name="recurrente" value="1"> Ingreso recurrente 
												<span></span>
											</label>
